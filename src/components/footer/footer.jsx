...
const Footer = () => {
  return (
    <div className="w-full flex flex-col  footer absolute left-0 px-[96px] mt-[180px] ">
        <div className="aloqa  flex flex-row  items-center justify-around gap-20 py-[50px]">
          <div className="flex flex-col justify-between items-start gap-[42px]">
            ...
            <div>
              ...
              <p className="text-[#25B679] text-[18px] font-[500]">+998 (88) 999 66 22</p>
            </div>
            <div className="">
            </div>
          </div>
            <div className="links">
              <ul className="flex flex-col justify-between items-start gap-3 text-[#040303] text-[18px] font-[400]">
