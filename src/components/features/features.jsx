    ...
    return (
        <div className='features flex items-center flex-col pt-[100px]'>
            ...
            <h1 className='text-3xl text-center pt-[12px]'>Ilovamiz xususiyatlari sizga<br />
                albatta yoqadi  </h1>
            <div className='flex lg:flex-row md:flex-col justify-center items-center pt-[64px] lg:gap-10 gap-20 text-[#040303] '>
                <div className='lg:flex md:grid grid-cols-2 flex-col gap-[100px] '>
                    <div className='w-[342px]  h-[88px] flex lg:flex-row md:flex-col justify-center items-center'>
            ...
            {/* qanday ishlaydi  */}
            <div className='mt-[100px] lg:h-[570px] md:h-full rounded-[24px] bg-[#25B679] w-full flex flex-col items-center mb-[100px] pb-2'>
                ...
                <div className='lg:flex md:grid grid-cols-2 flex-row items-center lg:gap-[150px] md:gap-[100px] mt-[50px] justify-center'>
                    <div className='xl:w-[230px] lg:w-[180px] md:w-[200px] relative h-[220px] flex flex-col justify-start gap-4'>
                        <h1 className='lg:text-[26px]  w-[55px] h-[56px] items-center rounded-full px-[13px] py-[10px] font-bold text-[#25B679] bg-white p-[10px] flex justify-center'>01</h1>
                        <h2 className='text-[23px] text-white font-bold'>Yuklab olish</h2>
                        <p className='text-[16px] text-white font-[400] opacity-[0.85]'>Ilovamizni PlayMarket yoki
                    ...
                    <div className='xl:w-[230px] lg:w-[180px] md:w-[200px] relative h-[220px] flex flex-col justify-start gap-4'>
                        <h1 className='lg:text-[26px]  w-[55px] h-[56px] items-center rounded-full px-[13px] py-[10px] font-bold text-[#25B679] bg-white p-[10px] flex justify-center'>02</h1>
                        <h2 className='text-[23px] text-white font-bold'>Ro’yxatdan o’tish</h2>
                        <p className='text-[16px] text-white font-[400] opacity-[0.85]'>Yuklab olgandan keyin ilovamizga
                    ...
                    <div className='xl:w-[230px] lg:w-[180px] md:w-[200px] h-[200px] fle2 flex-col justify-start gap-4'>
                        <h1 className='lg:text-[26px]  w-[55px] h-[56px] items-center rounded-full px-[13px] py-[10px] font-bold text-[#25B679] bg-white p-[10px] flex justify-center'>03</h1>
                        <h2 className='text-[23px] text-white font-bold'>Tugallandi!</h2>
                        <p className='text-[16px] text-white font-[400] opacity-[0.85]'>Ilovaga kirib barcha xizmatlardan
